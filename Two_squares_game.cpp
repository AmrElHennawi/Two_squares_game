...
{
    cout << setw(3) << table[0][0] << " | " << setw(3) << table[0][1] << " | " << setw(3) << table[0][2] << " | " << setw(3) << table[0][3] << endl;
    cout << setw(3) << table[1][0] << " | " << setw(3) << table[1][1] << " | " << setw(3) << table[1][2] << " | " << setw(3) << table[1][3] << endl;
    cout << setw(3) << table[2][0] << " | " << setw(3) << table[2][1] << " | " << setw(3) << table[2][2] << " | " << setw(3) << table[2][3] << endl;
    cout << setw(3) << table[3][0] << " | " << setw(3) << table[3][1] << " | " << setw(3) << table[3][2] << " | " << setw(3) << table[3][3] << endl;
}
//___________________________________________________________________________________
